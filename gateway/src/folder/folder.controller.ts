...
export class FolderController {
  ...
  create(
    ...
    return this.folderService.create(user.accessToken, createFolderDto);
  }
  ...
  rename(
    ...
    return this.folderService.rename(user.accessToken, renameFolderDto);
  }
  ...
  delete(
    ...
    return this.folderService.delete(user.accessToken, deleteFolderDto);
  }
  ...
  folder(
    ...
    return this.folderService.getFolder(user.accessToken, folderId);
  }
}
